...
by [Jordi Vicens Farrús](http://www.jordivicensfarrus.com/) which does the plugin compatible with PHP 5.6,
based on code from a [forked by Mark Rowatt Anderson](https://www.rowatt.com).
